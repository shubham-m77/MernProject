          ...
          <div className="login-section row">
            <div className="col-md-6">
              ...
              <div className="loginForm px-3 bg-dark rounded pt-2 pb-1">
                <h2 className="login-header text-light mt-1">Login/Sign-in</h2><hr className='box-border'/><br />
                <form onSubmit={handleSubmit} className='login-form'>
               

                <div className="form-input pt-3"><label htmlFor="email">Email</label><br />
                <input type="email" name='email' value={user.email} onChange={userHandler} placeholder="Enter your email" className='form-control' id='email'/>
                </div>
                ...
                <button type="submit" className='btn btn-primary rounded-pill signup-btn' >Login Now <i className="fa-solid fa-arrow-right"></i></button></div>
                </form>
                <p className='text-light text-center reg-login-btn-text '>Don't have an Account? <Link to="/register" className="sign-semi-btn px-2 py-1">Sign-up</Link></p>
              </div>
              </div>
          </div> </div>
        </main>
